import React__default, { createContext, useState, useEffect, useRef, useContext, useMemo, createElement } from 'react';
...
var EmojiInput = function EmojiInput(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    placeholder: placeHolder ? placeHolder : 'Tapez votre réponse ici.',
    type: 'text',
    value: text,
...
var _handlePastedText = function handlePastedText(text, html, editorState, onChange) {
  console.log(html);
  ...
  var newContentState = Modifier.insertText(editorState.getCurrentContent(), collapsedSelection, cleanText(text), editorState.getCurrentInlineStyle());
...
var SubmitButton = function SubmitButton(_ref) {
  ...
  var submitText = function submitText() {
    ...
    var htmlContent = draftToHtml(rawContent).trim();
    if (htmlContent !== '<p></p>') {
...
var AdvancedInput = function AdvancedInput(_ref2) {
  var handleSubmit = _ref2.handleSubmit,
    imgDiv = _ref2.imgDiv,
    imgStyle = _ref2.imgStyle,
    customImg = _ref2.customImg,
    text = _ref2.text,
  ...
  var contentState = useMemo(function () {
    if (html) {
  ...
  return React__default.createElement("div", {
    ...
    handlePastedText: function handlePastedText(text, editorState, html, onChange) {
      return _handlePastedText(text, editorState, html, onChange);
    },
    toolbarCustomButtons: [React__default.createElement(SubmitButton, {
      key: "submit-button",
      editorState: editorState,
...
var InputField = function InputField(_ref) {
  ...
  var handleSubmit = function handleSubmit(advText) {
    try {
...
var CommentStructure = function CommentStructure(_ref) {
  ...
  var replyTopSection = function replyTopSection() {
    return React__default.createElement("div", {
      ...
      className: 'userInfo'
    }, React__default.createElement("div", null, React__default.createElement("b", null, info.fullName, ":"), info.text), userInfo()), currentUser && optionsMenu());
  };
  var replyBottomSection = function replyBottomSection() {
    return React__default.createElement("div", {
      ...
      className: 'userInfo'
    }, globalStore.advancedInput ? React__default.createElement("div", {
      style: {
        display: "flex"
      }
    }, React__default.createElement("img", {
    ...
    }, React__default.createElement("span", null, React__default.createElement("b", null, info.fullName, ":\xA0")), React__default.createElement("span", {
    ...
    }, "R\xE9pondre")))) : React__default.createElement("div", {
      className: 'infoStyle'
    }, React__default.createElement("b", null, info.fullName, ":"), info.text)), currentUser && optionsMenu());
  };
...
var NoComments = function NoComments() {
  return React__default.createElement("div", {
    className: 'no-comDiv'
  }, ' ', "Aucun commentaire ici. Soyez le premier \xE0 commenter !");
};
...
var CommentSection = function CommentSection(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    style: titleStyle
  }, globalStore.commentsCount || totalComments(), ' ', totalComments() === 1 ? 'Commentaire' : 'Commentaires'), React__default.createElement("hr", {
    className: 'hr-style',
    style: hrStyle
