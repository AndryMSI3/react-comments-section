...
var _handlePastedText = function handlePastedText(text, html, editorState, onChange) {
  ...
  var newContentState = draftJs.Modifier.insertText(editorState.getCurrentContent(), collapsedSelection, cleanText(text), editorState.getCurrentInlineStyle());
...
var AdvancedInput = function AdvancedInput(_ref2) {
  ...
  var contentState = React.useMemo(function () {
    if (html) {
      var contentBlock = htmlToDraft(html);
      return draftJs.ContentState.createFromBlockArray(contentBlock.contentBlocks);
    }
