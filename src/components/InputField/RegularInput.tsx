    ...
    >
      ...
      {globalStore.removeEmoji ? (
        <input
          ...
          type='text'
          placeholder={placeHolder ? placeHolder : 'Tapez votre réponse ici.'}  // Placeholder par défaut ou personnalisé
      ...
      {/* Bouton "Répondre", désactivé si le champ de texte est vide */}
      <button
        className='postBtn'
        type='submit'
